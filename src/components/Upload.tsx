  ...
  return (
    <div className="space-y-2">
      <div
        ...
        onDrop={onDrop}
        className={`glass-strong h-[30vh] gap-1.25 flex flex-col items-center justify-center relative p-8 text-center transition ${isDragging ? 'ring-2 ring-indigo-400/60' : 'border-dashed'} focus:outline-none focus-visible:ring`}
